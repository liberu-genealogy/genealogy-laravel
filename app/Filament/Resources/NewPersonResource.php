...
use App\Filament\Resources\NewPersonResource\Pages;
...
class NewPersonResource extends Resource
{
    protected static ?string $model = NewPerson::class;
    ...
    {
        return [
            'index' => Pages\ListNewPeople::route('/'),
            'create' => Pages\CreateNewPerson::route('/create'),
            'edit' => Pages\EditNewPerson::route('/{record}/edit'),
        ];
    }
}
