...
use App\Filament\Resources\NewAddrResource\Pages;
use App\Filament\Resources\NewAddrResource\RelationManagers;
use App\Models\NewAddr;
use Filament\Forms;
...
class NewAddrResource extends Resource
{
    protected static ?string $model = NewAddr::class;
    ...
    {
        return [
            'index' => Pages\ListNewAddrs::route('/'),
            'create' => Pages\CreateNewAddr::route('/create'),
            'edit' => Pages\EditNewAddr::route('/{record}/edit'),
        ];
    }
}
