...
use App\Filament\Resources\NewFamilyEventResource\Pages;
use App\Filament\Resources\NewFamilyEventResource\RelationManagers;
use App\Models\NewFamilyEvent;
use Filament\Forms;
...
class NewFamilyEventResource extends Resource
{
    protected static ?string $model = NewFamilyEvent::class;

    protected static ?string $navigationLabel = 'family Event';
    ...
    {
        return [
            'index' => Pages\ListNewFamilyEvents::route('/'),
            'create' => Pages\CreateNewFamilyEvent::route('/create'),
            'edit' => Pages\EditNewFamilyEvent::route('/{record}/edit'),
        ];
    }
}
