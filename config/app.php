...
return [
     ...
     * config/app.php
     *
     * This file contains the configuration settings for the Laravel application.
     * It includes settings for the application name, environment, debug mode,
     * URL, timezone, locale, encryption key, maintenance mode, service providers,
     * class aliases, broadcasting, and Laravel Echo.
     */
