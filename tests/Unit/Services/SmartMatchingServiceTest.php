...
class SmartMatchingServiceTest extends TestCase
{
    ...
    public function test_service_initializes_with_configured_providers(): void
    {
    ...
    public function test_find_smart_matches_returns_collection_for_user_with_no_missing_parents(): void
    {
        Http::fake();
    ...
    public function test_find_smart_matches_calls_providers_when_people_have_missing_parents(): void
    {
        Http::fake([
    ...
    public function test_service_works_without_configured_providers(): void
    {
